...
namespace Proj
{
    public partial class OpenGL 
    {
        ...
        private static extern IntPtr glGetAsciiString(uint name);
        ...
        public static extern void glGetPointerv(uint pname, IntPtr paramsx);
        ...
        public static extern void glTexImage1D(uint target, int level, int internalformat, int width, int border, uint format, uint type, IntPtr pixels);
